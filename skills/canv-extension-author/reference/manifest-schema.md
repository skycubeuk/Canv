...
This reference covers the deep schema details for `manifest.settings` and `manifest.activationEvents`.
For the top-level field overview, see `reference/conventions.md`.
