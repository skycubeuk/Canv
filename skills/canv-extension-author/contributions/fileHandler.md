...
| `id` | YES | **kebab-case**, matches `/^[a-z][a-z0-9-]{0,63}$/` — lowercase letters, digits, hyphens; must start with a letter. Examples: `"main"`, `"pdf-viewer"`, `"image-grid"`. Rejected: `"Main"`, `"pdfViewer"`, `"pdf_viewer"`, `"1main"`. Unique within this extension. |
